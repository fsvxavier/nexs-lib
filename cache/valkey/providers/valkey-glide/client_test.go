...
// MockClient é um mock do valkey-glide client para testes
type MockGlideClient struct {
	responses map[string]interface{}
	errors    map[string]error
}

func (m *MockGlideClient) Get(ctx context.Context, key string) (string, error) {
...
func (m *MockGlideClient) Set(ctx context.Context, key, value string) (string, error) {
...
func (m *MockGlideClient) Ping(ctx context.Context) (string, error) {
