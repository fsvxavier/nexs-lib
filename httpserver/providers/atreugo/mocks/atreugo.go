// Package mocks provides mock implementations for testing the Atreugo HTTP server provider.
package mocks
...
// MockAtreugoServer is a mock implementation of interfaces.HTTPServer for testing.
type MockAtreugoServer struct {
...
// NewMockAtreugoServer creates a new mock Atreugo server.
func NewMockAtreugoServer() *MockAtreugoServer {
	return &MockAtreugoServer{
		Running:      false,
		Addr:         "localhost:8080",
...
func (m *MockAtreugoServer) Start() error {
	if m.StartFunc != nil {
		return m.StartFunc()
	}
	m.Running = true
...
func (m *MockAtreugoServer) Stop(ctx context.Context) error {
	if m.StopFunc != nil {
...
func (m *MockAtreugoServer) SetHandler(handler http.Handler) {
...
func (m *MockAtreugoServer) GetAddr() string {
...
func (m *MockAtreugoServer) IsRunning() bool {
...
func (m *MockAtreugoServer) GetConfig() *config.Config {
...
func (m *MockAtreugoServer) GracefulStop(ctx context.Context, drainTimeout time.Duration) error {
...
func (m *MockAtreugoServer) Restart(ctx context.Context) error {
...
func (m *MockAtreugoServer) GetConnectionsCount() int64 {
...
func (m *MockAtreugoServer) GetHealthStatus() interfaces.HealthStatus {
...
func (m *MockAtreugoServer) PreShutdownHook(hook func()) error {
...
func (m *MockAtreugoServer) PostShutdownHook(hook func()) error {
...
func (m *MockAtreugoServer) SetDrainTimeout(timeout time.Duration) {
...
func (m *MockAtreugoServer) WaitForConnections(ctx context.Context) error {
...
// Ensure MockAtreugoServer implements interfaces.HTTPServer.
var _ interfaces.HTTPServer = (*MockAtreugoServer)(nil)

// MockFactory is a factory function for creating mock Atreugo servers.
