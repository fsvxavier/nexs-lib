// Package mocks provides mock implementations for testing the FastHTTP server provider.
package mocks
...
// MockFastHTTPServer is a mock implementation of interfaces.HTTPServer for testing.
type MockFastHTTPServer struct {
...
// NewMockFastHTTPServer creates a new mock FastHTTP server.
func NewMockFastHTTPServer() *MockFastHTTPServer {
	return &MockFastHTTPServer{
		Running:      false,
		Addr:         "localhost:8080",
...
func (m *MockFastHTTPServer) Start() error {
	if m.StartFunc != nil {
		return m.StartFunc()
	}
	m.Running = true
...
func (m *MockFastHTTPServer) Stop(ctx context.Context) error {
	if m.StopFunc != nil {
...
func (m *MockFastHTTPServer) SetHandler(handler http.Handler) {
...
func (m *MockFastHTTPServer) GetAddr() string {
...
func (m *MockFastHTTPServer) IsRunning() bool {
...
func (m *MockFastHTTPServer) GetConfig() *config.Config {
...
func (m *MockFastHTTPServer) GracefulStop(ctx context.Context, drainTimeout time.Duration) error {
...
func (m *MockFastHTTPServer) Restart(ctx context.Context) error {
...
func (m *MockFastHTTPServer) GetConnectionsCount() int64 {
...
func (m *MockFastHTTPServer) GetHealthStatus() interfaces.HealthStatus {
...
func (m *MockFastHTTPServer) PreShutdownHook(hook func()) error {
...
func (m *MockFastHTTPServer) PostShutdownHook(hook func()) error {
...
func (m *MockFastHTTPServer) SetDrainTimeout(timeout time.Duration) {
...
func (m *MockFastHTTPServer) WaitForConnections(ctx context.Context) error {
...
// Ensure MockFastHTTPServer implements interfaces.HTTPServer.
var _ interfaces.HTTPServer = (*MockFastHTTPServer)(nil)

// MockFactory is a factory function for creating mock FastHTTP servers.
