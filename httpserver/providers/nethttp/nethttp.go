// Package nethttp provides an HTTP server implementation using the standard net/http package.
package nethttp
...
// Server implements interfaces.HTTPServer using net/http.
type Server struct {
	mu                sync.RWMutex
	server            *http.Server
...
// NewServer creates a new net/http server instance.
...
func (s *Server) Start() error {
	...
	// Create a channel to capture the server error
...
// Factory function for creating net/http servers.
