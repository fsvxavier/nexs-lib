...
func (lgr *Logger) setFields(ctx context.Context, fields ...zap.Field) []zap.Field {
	...
	fields = append(
		...
		zap.Uint64("dd.trace_id", sfc.Context().TraceIDLower()),
...
func DebugCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Debug(ctxs, fmsg, fieldsZap...)
}

func InfoCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Info(ctxs, fmsg, fieldsZap...)
}

func WarnCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Warn(ctxs, fmsg, fieldsZap...)
}

func ErrorCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Error(ctxs, fmsg, fieldsZap...)
}

func FatalCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Fatal(ctxs, fmsg, fieldsZap...)
}

func PanicCode(ctx context.Context, code, msg string, fields ...interface{}) {
	instance := NewLogger()
	ctxs, fmsg := Formatter(ctx, code, msg)
	fieldsZap := interface2field(fields)
	instance.Panic(ctxs, fmsg, fieldsZap...)
}
